        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="tambah_projek.php" class="btn btn-flat btn-success">Tambah Projek</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="table-user" class="table table-bordered table-hover">
                ...
                include('../koneksi.php');
                $no = 1;
                $query = mysqli_query($konek, "SELECT * FROM tbl_board ORDER BY nama_pic asc");
                ...
                <tr>
                  ...
                  <td><a href="edit-projek.php?id=<?= $data['id_board'] ?>" class="btn btn-flat btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>|<a href="delete_projek.php?id=<?= $data['id_board'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-flat btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                </tr>
                <?php $no++; } ?>
                </tbody>
              </table>
